...
namespace CarRental.Controllers
{
    public class CarDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CarId,CarNo,CarModel,Available,Make")] CarDetail carDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CarId,CarNo,CarModel,Available,Make")] CarDetail carDetail)
        {
            if (ModelState.IsValid)
            {
